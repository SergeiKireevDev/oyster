...
export async function init(state) {
  const { listTunnels, reserveHublot, openTunnel, closeTunnel, closeAllTunnels, spawnHublotAgent } =
  ...
  const tunnelRoutes = createTunnelRoutes({
    state, appStore, config, requestContext, listTunnels, reserveHublot, openTunnel, closeTunnel,
