...
export async function init(state) {
  const { listTunnels, reserveHublot, recordHublotTransition, openTunnel, closeTunnel, closeAllTunnels, spawnHublotAgent } =
  ...
  const tunnelRoutes = createTunnelRoutes({
    state, appStore, config, requestContext, listTunnels, reserveHublot, recordHublotTransition, openTunnel, closeTunnel,
