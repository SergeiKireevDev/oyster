...
import {
  ...
  PINNED_WIDGET_PIN_PATH_ACTION,
  PINNED_WIDGET_PIN_LINK_ACTION,
  ...
  return {
    ...
    configureActions(actions) {
      ...
      actionDetachers.push(
        ...
        deps.uiActions.register(FILE_EXPLORER_PIN_ACTION, actions.fileExplorer.pin ?? (() => {})),
        ...
        deps.uiActions.register(PINNED_WIDGET_OPEN_ACTION, actions.pinnedWidgets?.open ?? (() => {})),
        deps.uiActions.register(PINNED_WIDGET_MANAGE_ACTION, actions.pinnedWidgets?.manage ?? (() => {})),
        deps.uiActions.register(PINNED_WIDGET_MOVE_ACTION, actions.pinnedWidgets?.move ?? (() => {})),
        deps.uiActions.register(PINNED_WIDGET_MOVE_GROUP_ACTION, actions.pinnedWidgets?.moveGroup ?? (() => {})),
        deps.uiActions.register(PINNED_WIDGET_PIN_PATH_ACTION, actions.pinnedWidgets?.pinPath ?? (() => {})),
        deps.uiActions.register(PINNED_WIDGET_PIN_LINK_ACTION, actions.pinnedWidgets?.pinLink ?? (() => {})),
