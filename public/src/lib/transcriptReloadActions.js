...
export async function loadCanonicalTranscript({ getState, getMessages, getDurableMessages, shouldGetDurableMessages = (state) => Boolean(state?.sessionFile), applyState, onState, onMessages, onDurableMessages }) {
