...
- [x] Add tests for scope changes, cross-refresh ordering, listener uniqueness, and remount teardown.
...
- [x] Add remount tests proving listeners attach once and detach completely.
...
- [x] Run the full build, unit tests, Docker validation, and browser/e2e suite.
