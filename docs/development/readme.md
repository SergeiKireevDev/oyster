...
Read [Architecture](/development/architecture/) and the [hot-reload lifecycle inventory](/development/hot-reload-lifecycle/) before changing lifecycle code, then follow [Contributing](/development/contributing/) to avoid hot-reload regressions.
