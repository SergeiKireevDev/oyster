...
const manifest = createReloadManifest({
  ...
  domain: [
    ...
    "codex-oauth-credential-sink.mjs",
    "gemini-oauth-credential-sink.mjs",
    "openrouter-routing.mjs",
    ...
    "runner-drivers/secret-output.mjs",
    "runners.mjs",
