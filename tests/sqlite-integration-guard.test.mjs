...
test("opening and migrating pi-lot-ui.sqlite leaves the coding-agent schema unchanged", (t) => {
  ...
  assert.deepEqual(appTables, ["app_sessions", "app_settings", "checkpoints", "hublot_lifecycle_events", "hublot_processes", "hublots", "operations", "routine_log_lines", "routine_runs", "routines", "runner_events", "runners", "schema_migrations"]);
